...
//				是否显示(自定义)
//                $r['str_manage'] .= '<a href="' . U("Category/edit", array("catid" => $r['catid'])) . '">修改</a> | <a class="J_ajax_del" href="' . U("Category/show", array("catid" => $r['catid'])) . '">删除</a>';
